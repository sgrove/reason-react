...
module Synthetic: {
  ...
  external currentTarget : synthetic 'a => ReasonJs.Dom.element = "" [@@bs.get];
  ...
  external target : synthetic 'a => ReasonJs.Dom.element = "" [@@bs.get];
...
module Clipboard: {
  ...
  external currentTarget : t => ReasonJs.Dom.element = "" [@@bs.get];
  ...
  external target : t => ReasonJs.Dom.element = "" [@@bs.get];
...
module Focus: {
  ...
  external _type : t => string = "type" [@@bs.get];
  external persist : unit = "" [@@bs.send.pipe : t];
  external relatedTarget : t => ReasonJs.Dom.element =
    "" [@@bs.get]; /* Should return Dom.eventTarget */
};
...
module UI: {
  ...
  external view : t => ReasonJs.Dom.window =
    "" [@@bs.get]; /* Should return DOMAbstractView/WindowProxy */
};
